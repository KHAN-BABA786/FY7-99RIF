...
module.exports.handleEvent = async function({
  ...
  if ((void 0 === i.resend || 0 != i.resend) && l != global.data.botID && ("message_unsend" != e.type && global.logMessage.set(g, {
    ...
    if (!m) return;
    let e = await s.getNameUser(l);
    if (null == m.attachment[0]) return a.sendMessage(`NAME  𒁍 ${e}\nDELET MESSAGE 𒁍 1\nRESEND MESAAGE  𒁍 ${m.msgBody}\nOWNER  𒁍 ARIF-BABU`, u); {
      let t = 0,
        s = {
          body: `NAME  𒁍 ${e}\nDELET PHOTO  𒁍  ${m.attachment.length}\nOWNER 𒁍 ARIF-BABU ${""!=m.msgBody?`\n\nContent: ${m.msgBody}`:""}`,
          attachment: [],
          mentions: {
            tag: e,
            id: l
